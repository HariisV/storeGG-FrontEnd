          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Your Game Id" value="GGWP" />
                <Row label="Order  Id" value="GGWP" />
                <Row label="Item" value="GGWP" />
                <Row label="Price" value="GGWP" />
                <Row label="Tax (10%)" value="GGWP" />
                <Row label="Total" value={50000} className="color-palette-4" />
              </div>
